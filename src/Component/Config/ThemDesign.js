...
export const ContainerOfInput = styled(Box)(({ theme, mainTheme, customeWidth }) => ({
...
export const ContainerOfInputFields = styled(Box)(({ theme,customePaddingRight,paddingHorizontal,customePaddingVertical, mainTheme, customeWidth,customHeight, haswidth, isForm, hasMultiLine,direction,maxHeight,...props}) => ({
    // boxShadow: "0px 12px 40px #00000014 !important", 
    // background: "#FFFFFF 0% 0% no-repeat padding-box !important", 
    ...
    '& textarea':{
        ...
        maxHeight: hasMultiLine?maxHeight?maxHeight:'200px !important':customHeight?customHeight:'55px !important',
    ...
    '& .MuiTextField-root,& .MuiTextField-root .MuiFilledInput-root': {
        minHeight: customHeight?customHeight:hasMultiLine ? '45px !important' :'55px !important',
        width: '100%',
        background: "#FFFFFF 0% 0% no-repeat padding-box !important",
        boxShadow: isForm ? "0px 2px 10px -2px lightgrey !important" : "0px 6px 20px #00000014 !important",
        opacity: "1 !important",
    ...
    '& .MuiTextField-root .MuiFormLabel-root': {
        ...
        letterSpacing: "0.7px",
        color: `${mainTheme?.colorblack} !important`,
        opacity: "0.95"
    },
    '& .MuiTextField-root .MuiFilledInput-input': {
        textAlign: "left",
...
export const ContainerOfSelectField = styled(Box)(({ theme, mainTheme, customeWidth,customHeight, haswidth, hasError, isForm, customPadding }) => ({
    // boxShadow: "0px 12px 40px #00000014 !important", 
    // background: "#FFFFFF 0% 0% no-repeat padding-box !important", 
    // boxShadow: "0px 0px 40px 10px #00000014 !important", 
    opacity: "1 !important",
    ...
    '& .MuiAutocomplete-root.MuiAutocomplete-hasClearIcon ::before': {
        ...
        width: '5px !important',
        height: '100% !important',
        background: hasError ? 'red !important' : mainTheme?.iconColor + ' !important',
